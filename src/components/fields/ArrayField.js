...
function DefaultArrayItem(props) {
  ...
  return (
    <div key={props.index} className={['row', props.className].join(' ')}>
      <div className={"col"/*props.hasToolbar ? "col-xs-9" : "col-xs-12"*/}>
        {props.children}
      </div>

      {props.hasToolbar && (
        <div className="{col array-item-toolbox">
          <div
            className="btn-group"
...
class ArrayField extends Component {
  ...
  onDropIndexClick = index => {
    return event => {
      ...
      onChange(formData.filter((_, i) => i !== index), { validate: true, action: "drop", index: index });
    };
  };
