...
function BaseInput(props) {
  ...
  var theme = props.theme,
      ...
      inputProps = _objectWithoutProperties(props, ["theme", "value", "readonly", "disabled", "autofocus", "onBlur", "onFocus", "options", "schema", "formContext", "registry"]);
