...
function IconBtn(props) {
  ...
  return _react2.default.createElement(
    ...
    _extends({
      type: "button",
      className: "btn btn-" + type + " btn-sm " + className
    }, otherProps),
    icon
  );
}
...
function DefaultArrayItem(props) {
  ...
  return _react2.default.createElement(
    "div",
    { key: props.index, className: ['row', props.className].join(' ') },
    _react2.default.createElement(
      "div",
      { className: "col" /*props.hasToolbar ? "col-xs-9" : "col-xs-12"*/ },
      props.children
    ),
    props.hasToolbar && _react2.default.createElement(
      "div",
      { className: "{col array-item-toolbox" },
      _react2.default.createElement(
        "div",
        {
          className: "btn-group",
          style: { display: "inline", justifyContent: "space-around" } },
...
var ArrayField = function (_Component) {
  ...
  function ArrayField() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref3 = ArrayField.__proto__ || Object.getPrototypeOf(ArrayField)).call.apply(_ref3, [this].concat(args))), _this), _this.onAddClick = function (event) {
      ...
      _this.props.onChange([].concat(_toConsumableArray(formData), [(0, _utils.getDefaultFormState)(itemSchema, undefined, definitions)]), { validate: false, action: "add" });
      ...
      return function (event) {
        ...
        onChange(formData.filter(function (_, i) {
          return i !== index;
        }), { validate: true, action: "drop", index: index });
      };
...
function AddButton(_ref4) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      "p",
      { className: "col-xs-3 col-xs-offset-9 array-item-add" },
